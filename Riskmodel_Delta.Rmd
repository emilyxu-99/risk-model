...
#Reminder: make sure to run Shiny_Alpha.R & Riskmodel_Beta.R before running the app!
...
renderValueBox({
  ...
  valueBox(
    value = mm,
"Micromorts: A micromort is a unit of risk defined as one-in-a-million chance of death.",
color = c("#393c8fff")
  )
})
```
...
renderPlot({
  ...
  mm %>%
    ...
    theme_minimal() +
    scale_fill_manual(values=c("#00008B", "#ffed00ff")) +
